...
class cursive_data(threading.Thread):
    ...
    def add_datapoint(self, key, value):
        ...
        input_data = [{"data": {key   : value             },"date":timestamp}]
	...
	self.logger.info(self.datastore_id)
        r = requests.patch(cursive_data.url + str(self.datastore_id) + "/",headers=headers,json=data)
